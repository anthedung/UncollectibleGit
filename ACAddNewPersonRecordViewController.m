...
- (void)displayPerson:(ABRecordRef)person
{
    ...
    self.personNameValue.text = fullName;
    self.personIDValue.text = [NSString stringWithFormat:@"%d", self.personID];
    
    [self isExistingInPersonList:fullName];
}
...
- (IBAction)changeUpdateTheList:(id)sender {
    ...
    if (![self.personNameValue.text isEqualToString:@"-"] &&
        ...
        ACDebtRecord *newDebtRecord = [ACDebtRecord createNewACDebtRecordWithName:name amount:amount andDebtNote:@""];
        ...
        if (self.isPersonExisting){
            ...
            ACPerson *newPerson = [ACPerson createNewPersonWitFirsthName:self.firstName andLastName:self.lastName andPersonID:personID];
